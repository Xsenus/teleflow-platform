...
Упало:                       0
Функциональных модулей:      42
Statements:                  17 997
Missed statements:           2 608
Statement coverage:          85,51%
Обязательный gate:           80%
Полный прогон:               266,2 секунды
Coverage-прогон:             556,9 секунды, шесть завершённых наборов
```

Финальный полный запуск завершён с 372 passed, 2 ожидаемыми Windows skip и без падений.
Coverage объединён из шести завершённых непересекающихся наборов 305 + 26 + 32 + 6 + 3 + 2
теста. Данные монолитного запуска, ранее остановленного внешним timeout на загруженной машине,
не учитывались.
...
802 до 266,2 секунды (примерно на 67%), хотя набор расширен до 374 тестов.
