...
Упало:                       0
Функциональных модулей:      48
Statements:                  18 002
Missed statements:           2 420
Statement coverage:          86,56%
Обязательный gate:           80%
Полный прогон:               252,5 секунды
Coverage-прогон:             707,6 секунды, двенадцать завершённых наборов
```

Финальный полный запуск завершён с 389 passed, 2 ожидаемыми Windows skip и без падений.
Coverage объединён из двенадцати завершённых непересекающихся наборов
305 + 26 + 32 + 6 + 3 + 2 + 3 + 3 + 3 + 3 + 1 + 4 теста. Данные монолитного запуска,
ранее остановленного внешним timeout на загруженной машине, не учитывались.
...
802 до 252,5 секунды (примерно на 69%), хотя набор расширен до 391 теста.
