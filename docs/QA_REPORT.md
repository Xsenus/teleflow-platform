...
Упало:                       0
Функциональных модулей:      32
Statements:                  17 997
Missed statements:           3 526
Statement coverage:          80,41%
Обязательный gate:           80%
Полный прогон:               308 секунд
Coverage-прогон:             351,9 секунды
```
...
802 до 308 секунд (примерно на 62%). Linux release-QA по-прежнему запускает модули и
