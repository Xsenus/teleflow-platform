...
Упало:                       0
Функциональных модулей:      52
Statements:                  18 002
Missed statements:           2 220
Statement coverage:          87,67%
Обязательный gate:           80%
Полный прогон:               363,3 секунды
Coverage-прогон:             проверенная базовая матрица + 29,5 секунды новых ветвей
```

Финальный полный запуск завершён с 436 passed, 2 ожидаемыми Windows skip и без падений.
Coverage объединён из ранее проверенной полной матрицы и отдельной coverage-сессии всех 31
новых сценариев; полное функциональное выполнение текущего дерева отдельно проверило teardown.
...
802 до 363,3 секунды (примерно на 55%), хотя набор расширен до 438 тестов.
