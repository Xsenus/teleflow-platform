...
- Реальные подписанные Recovery drill receipts, inbound/outbox edge cases, S3 и User Admin lifecycle.
- Logging/Telegram factory, rule-based AI и pilot canary error semantics покрыты contract-тестами.
