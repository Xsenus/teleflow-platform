...
- Все 1 545 Python- и 156 JavaScript-функций защищены русскоязычным documentation gate.
...
- Добавлены lifecycle- и adapter-тесты; coverage production-кода повышен до 85,51%.
